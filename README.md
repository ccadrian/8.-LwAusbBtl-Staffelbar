...
| **Kassensturz** | Wenn das Kassen-Soll an ist: nach jeder Zählung (Knopf „Kasse zählen") den echten Kassenbestand über einen großen Euro-Zahlenblock eingeben. Die App zeigt live und gespeichert die **Differenz zum Soll** – „stimmt genau", „7,50 € fehlen" oder „2,50 € zu viel". Jeder Kassensturz hängt an seiner Zählung und ist im Protokoll nachschlagbar (dort auch wiederholbar). |
